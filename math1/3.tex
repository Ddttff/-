...
%\foreach \x/\xtext in {-1/ 2\x10+4=24 , -3/ 2\x 140+1=281 , -4/1 , -5/ 2\x1410+4=2824 , -6/4 , -2/4 }
%{
...
\includegraphics[width=\linewidth]{image/屏幕截图_18-6-2026_194722_.jpeg}
...
\quad$\because$ 查$\sqrt{3.714}=1.927$,\qquad $\therefore\; \sqrt{37140}=192.7$
...
\quad$\because$ 查$\sqrt{40}=6.325$,\qquad $\therefore\; \sqrt{0.00004}=0.006325$
...
\textbf{非比数}）．如：$\sqrt{2},\sqrt{3},\mathrm{e},\pi$都是无理数．
...
例如：$|\sqrt{3}|=\sqrt{3}$, $|0|=0$, $|-\mathrm{e}|=\mathrm{e}$．
...
\begin{enumerate}
    ...
    \item $2x^2+4x+(\qquad\quad   )=2(x+\qquad\quad  )^2$
    \item $-m^2+(\qquad\quad   )-64=-(m-\qquad\quad  )^2$
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item $\left(\sqrt{\frac{1}{2}}-3\sqrt{\frac{1}{8}}+2\sqrt{0.5}\right)\x \sqrt{8}$
        \end{multicols}
    \end{enumerate}
\end{enumerate}
\end{ex}
...
\[b^2-4ac=1-32=-31<0\]
$\therefore\quad $原方程无实数根，解集是空集$\varnothing$．
\end{enumerate}    
\end{solution}
